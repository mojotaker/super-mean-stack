...
# cp -r /vagrant/puppet/* $PUPPET_DIR
cp -r /home/vagrant/app/puppet/* $PUPPET_DIR
cd $PUPPET_DIR && librarian-puppet install --clean

# now we run puppet
puppet apply -vv  --modulepath=$PUPPET_DIR/modules/ $PUPPET_DIR/manifests/main.pp --fileserverconfig=$PUPPET_DIR/fileserver.conf